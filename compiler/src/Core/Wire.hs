...
--
-- @schema/geng/core/v6.proto@ in the @geng-lang@ repository is the schema of
...
-- | Version 6. See the header of @schema/geng/core/v6.proto@ for what bumping
...
-- the only reader, and M2's reader is the first that is not.
